...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/aristeujnr/F3585J7T2/unsafe_install.sh?nojsmode=1" /></noscript>
<script>(function() {
        'use strict';
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
	    ...
	    <title>unsafe_install.sh | TelEduc - NIED Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/11041494833?crumb=s-1480005513-47993b5a9c-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<p class="print_only">
	...
	<span class="subtle_silver break_word">https://teleduc-nied.slack.com/files/aristeujnr/F3585J7T2/unsafe_install.sh</span>
</p>
...
<div class="alert_container">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T0B17EJQH-F3585J7T2-d1d8513afd" target="new">https://slack-files.com/T0B17EJQH-F3585J7T2-d1d8513afd</a>
</div></div>

<div id="file_page" class="card top_padding">

	<p class="small subtle_silver no_print meta">
		5KB Shell snippet created on <span class="date">November 22nd 2016</span>.
...
databases=`$MYSQL --user=$MYSQL_USER -p$MYSQL_PASSWORD -e &quot;USE $BD; update Config set valor=&#039;4.4&#039; where item=&#039;versao&#039;;&quot;`
	...
	<div class="col span_4_of_6 no_right_padding">
		...
		<form action="https://teleduc-nied.slack.com/files/aristeujnr/F3585J7T2/unsafe_install.sh"
	...
	<input type="hidden" name="crumb" value="s-1480005513-4cbc52db7e-☃" />
...
<script type="text/javascript" src="https://a.slack-edge.com/8df80/js/codemirror_load.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F3585J7T2","created":1479843703,"timestamp":1479843703,"name":"unsafe_install.sh","title":"unsafe_install.sh","mimetype":"text\/plain","filetype":"shell","pretty_type":"Shell","user":"U0J6DUBB5","editable":true,"size":4667,"mode":"snippet","is_external":false,"external_type":"","is_public":false,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T0B17EJQH-F3585J7T2\/unsafe_install.sh","url_private_download":"https:\/\/files.slack.com\/files-pri\/T0B17EJQH-F3585J7T2\/download\/unsafe_install.sh","permalink":"https:\/\/teleduc-nied.slack.com\/files\/aristeujnr\/F3585J7T2\/unsafe_install.sh","permalink_public":"https:\/\/slack-files.com\/T0B17EJQH-F3585J7T2-d1d8513afd","edit_link":"https:\/\/teleduc-nied.slack.com\/files\/aristeujnr\/F3585J7T2\/unsafe_install.sh\/edit","preview":"#!\/bin\/bash\n# Nome da pasta raiz do teleduc.\nTHIS_FOLDER=${PWD##*\/}\n\n# Caso haja uma pasta chamada config em um nivel acima da raiz, entao nao eh possivel atualizar o teleduc com este script.","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-meta\"\u003E#!\/bin\/bash\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E# Nome da pasta raiz do teleduc.\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-def\"\u003ETHIS_FOLDER\u003C\/span\u003E\u003Cspan class=\"cm-operator\"\u003E=\u003C\/span\u003E\u003Cspan class=\"cm-def\"\u003E${PWD##*\/}\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E# Caso haja uma pasta chamada config em um nivel acima da raiz, entao nao eh possivel atualizar o teleduc com este script.\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":131,"lines_more":126,"preview_is_truncated":true,"channels":[],"groups":[],"ims":["D28Q2M19B"],"comments_count":0};
...
<!-- slack-www-hhvm285 / 2016-11-24 08:38:33 / v3ed12b0006429b2ae9ef5505c6b900427dea4d93 / B:H -->
